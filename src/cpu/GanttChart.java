...
public class GanttChart {
    // gantt chart
    private static int ganttX =150 ; // start drawing point on x-coordinate
    private static final int ganttY = 800; // Gantt location on y-coordinate 
    ...
    public static void clear(){
         List.clear();
         ganttX = 150;  // start location on x-coordinate
